...
if not game:GetService("CoreGui") then
    error("Executor không hỗ trợ CoreGui")
end

-- Tạo giao diện bằng Instance thủ công (không dùng thư viện ngoài)
local function CreateWindow()
    ...
    gridFrame.Size = UDim2.new(0, 440, 0, 380)
    gridFrame.Position = UDim2.new(0, 20, 0, 40)
    ...
    for i = 1, 5 do
        ...
        for j = 1, 5 do
            ...
            box.Position = UDim2.new(0, (j-1)*75 + 10, 0, (i-1)*75 + 10)
    ...
    calcBtn.Size = UDim2.new(0, 440, 0, 40)
    calcBtn.Position = UDim2.new(0, 20, 0, 430)
    ...
    -- Khung kết quả (ẩn ban đầu)
    local resultFrame = Instance.new("Frame")
    resultFrame.Size = UDim2.new(0, 440, 0, 400)
    resultFrame.Position = UDim2.new(0, 20, 0, 480)
    ...
    -- Danh sách từ (fallback + tải từ web)
    local WordList = {}
    ...
    calcBtn.MouseButton1Click:Connect(function()
        ...
        mainFrame.Size = UDim2.new(0, 480, 0, 520 + 420)
